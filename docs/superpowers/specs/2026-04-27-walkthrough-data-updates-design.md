...
walkthroughs[i].data_updates = [
  { kind: 'rag', project_id: 'Acme Industries-001', dimension: 'schedule', from: 'Amber', to: 'Red', rationale: '…', recorded_at: '…' },
  { kind: 'risk_status', project_id: 'Acme Industries-002', risk_index: 1, from: 'open', to: 'closed', rationale: '…', recorded_at: '…' },
  { kind: 'status', project_id: 'Acme Industries-003', from: 'In Progress', to: 'Blocked', rationale: '…', recorded_at: '…' },
  { kind: 'progress', project_id: 'Acme Industries-004', skill: 'size_engineering', sprint: 'CY26-S5', completed: 8, recorded_at: '…' }
]
```
