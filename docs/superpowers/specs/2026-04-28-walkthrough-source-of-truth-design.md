...
```
{
  ...
  dependencies: [
    { kind: 'blocked_by', target_id: 'Acme Industries-XYZ', target_name: 'Onboarding API', state: 'pending', target_date_iso: ... },
    { kind: 'blocks',     target_id: 'Acme Industries-ABC', target_name: 'UAT readiness', state: 'in_progress' }
  ]
}
```
