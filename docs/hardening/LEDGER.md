...
- Next lens: still L1 — finish open items H-003 (value= inputs), H-004 (alt/data),
  H-005 (handler ids), H-006 (remaining free-text title= sinks across app), then
  rotate to L2 (undo/audit contracts).
...
| H-006 | 2 | L1 | P1 | index.html remaining free-text `title="…"` sinks app-wide via esc() — Gantt p.name (≈26212/27624/27626), capacity tm.name (≈28225/33179), kanban card name/manager/assignee (≈29464/29567/29573/29814/42889), RAID descriptions (≈39406/39412/39417/39560), SoW flag_reason (≈45777), activity old/new value (≈22658), wt-ms-notes (≈28476) | Same bug class beyond Strategy. Convert each free-text value to `Dashboard.escAttr`; leave controlled enums (RAG/status/sprint-id/skill labels/dates) on esc. Open for a later L1 iteration. | Open | — |
