...
- **Status Report Drafter** — an AI skill that writes the periodic customer narrative from live project, RAID and billing data (grounded — it never invents figures), governed by `definitions/status-report/`, with review-and-edit before print.
