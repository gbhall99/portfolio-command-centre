...
describe('DetailPanel close — phantom ownership warning', () => {
  ...
  it('after migration, ownership values are always one of the dropdown options', async () => {
    resetIdSeq();
    const a = makeProject({ id: 'Acme Industries-OW-A' }); a.ownership = 'We Own';
    const b = makeProject({ id: 'Acme Industries-OW-B' }); b.ownership = 'Requirements Received';
    const c = makeProject({ id: 'Acme Industries-OW-C' }); delete c.ownership;
    const d = makeProject({ id: 'Acme Industries-OW-D' }); d.ownership = 'Lead & Delivery';
    const e = makeProject({ id: 'Acme Industries-OW-E' }); e.ownership = 'Delivery';
