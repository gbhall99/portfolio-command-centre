...
export async function loadApp(fixture, opts = {}) {
  ...
  const bridge =
    '<script>window.__pcc__ = { App, Solver, Sprint, Dashboard, Gantt, Capacity, Governance, DetailPanel, AuditPanel, Forecast, Walkthrough, Personas, Person, Objectives, Products, MetricGroups, Metrics, Strategy, MetricsView, PersonasView, ProductsView, Overview, RAID, Delivery, Format, Reports, ReportsHub, RaidIntel, RaidView, MyActions, CommandPalette, ScenarioLab, HealthCheck, AI, AgentTools, AgentMemory, Agent, Assistant, Kanban, Definitions, Skills, Sow, SowSkill, SowInterview, Wireframe, WireframeSkill, Billing, StatusReport, StatusReportSkill, ExtractSkill, Tableau, ProjectWizard, Tour };</script>';
  ...
  return {
    ...
    ReportsHub: handles.ReportsHub,
    RaidIntel: handles.RaidIntel,
    RaidView: handles.RaidView,
    Personas: handles.Personas,
    Person: handles.Person,
    Objectives: handles.Objectives,
    Products: handles.Products,
    Metrics: handles.Metrics,
    MetricGroups: handles.MetricGroups,
    Strategy: handles.Strategy,
    MetricsView: handles.MetricsView,
    PersonasView: handles.PersonasView,
    ProductsView: handles.ProductsView,
    MyActions: handles.MyActions,
    CommandPalette: handles.CommandPalette,
    ScenarioLab: handles.ScenarioLab,
    HealthCheck: handles.HealthCheck,
    AI: handles.AI,
    AgentTools: handles.AgentTools,
    AgentMemory: handles.AgentMemory,
    Agent: handles.Agent,
    Assistant: handles.Assistant,
    Kanban: handles.Kanban,
    ProjectWizard: handles.ProjectWizard,
    Definitions: handles.Definitions,
    Skills: handles.Skills,
    Sow: handles.Sow,
    SowSkill: handles.SowSkill,
    SowInterview: handles.SowInterview,
    Wireframe: handles.Wireframe,
    WireframeSkill: handles.WireframeSkill,
    Billing: handles.Billing,
    StatusReport: handles.StatusReport,
    StatusReportSkill: handles.StatusReportSkill,
    ExtractSkill: handles.ExtractSkill,
    Tableau: handles.Tableau,
    Tour: handles.Tour,
    teardown
  };
}
