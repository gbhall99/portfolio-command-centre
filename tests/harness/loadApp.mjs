...
export async function loadApp(fixture, opts = {}) {
  ...
  const bridge =
    '<script>window.__pcc__ = { App, Solver, Sprint, Dashboard, Gantt, Capacity, Governance, DetailPanel, AuditPanel, Forecast, Walkthrough, Personas, Person, Objectives, Products, MetricGroups, Metrics, Strategy, MetricsView, PersonasView, ProductsView, Overview, RAID, Delivery, Format, Reports, ReportsHub, RaidIntel, RaidView, MyActions, AI, AgentTools, AgentMemory, Agent, Assistant, Kanban, Definitions, Skills, Sow, SowSkill, Wireframe, WireframeSkill, Billing, StatusReport, StatusReportSkill, ExtractSkill, Tableau };</script>';
