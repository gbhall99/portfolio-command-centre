...
- **Customer-scoped** — `App.activeCustomer` is the single source of truth for customer selection. Changing it on any view syncs all views. Defaults to Acme Industries. No "All" option exists. Use `App.setActiveCustomer(value)` to change.
